$(document).ready(function () {
    ...
    var myCalendar = createCalendar({
        ...
        data: {
            // Event title
            title: "Jonathan and Lillian's Wedding",

            // Event start date
            start: new Date('Jun 14, 2020 16:30'),
            ...
            end: new Date('Jun 14, 2020 22:00'),

            // Event Address
            address: '701 N Pennsylvania St, Indianapolis, IN 46204',
    ...
    $('#rsvp-form').on('submit', function (e) {
        ...
        if (MD5($('#invite_code').val()) !== 'b0e53b10c1f55ede516b240036b88f40'
            ...
            $.post('https://script.google.com/macros/s/AKfycbxmcJnpzPQMzrlFBVLaQU4QA2IzC6MhypWAZF1sQw/exec', data)
                .done(function (data) {
                    console.log(data);
                    $('#alert-wrapper').html('');
